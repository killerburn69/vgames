...
const Overview = () => {
  ...
  return (
    <div>
        <FlexButton>
            <ButtonChange isStatus={status === 1} onClick={()=>onClickStatus(1)}>Grid View</ButtonChange>
            <ButtonChange isStatus={status === 2} onClick={()=>onClickStatus(2)}>List View</ButtonChange>
        </FlexButton>
        {status === 1 && (
